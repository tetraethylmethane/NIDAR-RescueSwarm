...
\textbf{\rs{7{,}34{,}379} across nine small steps}, each released only when
the previous one has produced a result. The first decision is INR~31,371 --
about four per cent of the whole -- and no single step exceeds INR~1,05,172.
...
reasons are identical to the tables above.
