...
usable window:
\[
\underbrace{105.5}_{\text{nominal}} + \underbrace{22.1}_{\text{re-sweep}}
+ \underbrace{60.8}_{\text{loiter}} = 188.4~\text{Wh usable},
\]
against 233.3\,Wh available at 80\% depth of discharge --- a margin of
\textbf{24\,\%}. Expressed independently of chemistry, any candidate
pack must therefore provide \textbf{236\,Wh} nameplate at \textbf{6S}
...
7.7\,min design mission consuming 105.5\,Wh.
...
\quad h = 4.712~\text{mm}, \quad d = 7.86~\text{mm},
\]
