...
%    * Fill the \author block (marked TODO below)
...
%------------------------------------------------------------------ TODO
\author{
\IEEEauthorblockN{TODO: Author One, Author Two, Author Three}
\IEEEauthorblockA{\textit{TODO: Department} \\
\textit{TODO: Institution}\\
TODO: City, India \\
TODO: email@institution.ac.in}
}
%-----------------------------------------------------------------------
...
\begin{itemize}
  ...
  \item \textbf{Inter-aircraft separation.} Staggered take-off delays encoded in
        the mission file, rather than in operator timing, increased the closest
        approach during launch from 1.31\,m to 92.12\,m. Worst-case en-route
        separation is 34.00\,m.
  \item \textbf{Recovery deconfliction.} Assigning landing slots to the corners
        ...
        1.22\,m to 2.61\,m at no cost, raising the measured minimum separation
        from an overlapping 0.83\,m to 2.27\,m --- a clearance of 1.22\,m
        between airframes.
  \item \textbf{Ground station.} All required operator displays verified against
        three live autopilots with three concurrent H.264 feeds, offline map
        tiles and end-to-end abort acknowledgement.
\end{itemize}
...
TODO: acknowledge institutional support, mentors, and any component suppliers
who provided evaluation hardware or engineering support.
