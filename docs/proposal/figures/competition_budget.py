...
GROUND = [
    ...
    ("Remaining ground items", 62_800, 40_000, "Cables, mounts, field consumables."),
]
...
SPARES = [
    ("Spare battery packs", 57_000, 38_000, "Two, not three."),
    ("Spare motors, 4", 28_000, 36_396, "REPRICED UP to the market figure of 9,099."),
    ...
    ("Spare compute module", 38_000, 20_000, "Repriced to the Option B part."),
    ...
    ("Remaining consumables", 37_800, 15_000, "Fasteners, tape, connectors, filament."),
]
...
SOFT = [
    ...
    ("WPC / ETA licensing", 10_000, 10_000, "KEEP. Regulatory."),
    ("DGCA airspace and operations", 5_000, 5_000, "KEEP. Regulatory."),
]

MULE = [
    ("Training airframe (1)", 0, 37_309,
     "ADDED. Flies from week 1 so the competition aircraft is not the only "
     "article exercising the ground station, radios and failsafes."),
]
