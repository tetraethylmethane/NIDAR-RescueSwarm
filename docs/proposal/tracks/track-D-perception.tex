...
\textbf{Ask: \inr{107,295}} $\cdot$ 1--2 students $\cdot$ Detector, tiling, geotagging, calibration, dataset
\end{center}
...
\midrule
AI accelerator (1 x 20,000 x 3 ac) & \textbf{K} & 60,000 \\
Camera + lens (1 x 11,100 x 3 ac) & \textbf{K} & 33,300 \\
\midrule
Subtotal & & 93,300 \\
Customs duty and freight & & 0 \\
GST & & 0 \\
Contingency at 15\% & & 13,995 \\
\midrule
\textbf{TRACK D ASK} & & \textbf{107,295} \\
\bottomrule
\end{tabular}
\end{center}
