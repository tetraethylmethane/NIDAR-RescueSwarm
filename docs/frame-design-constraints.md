...
> **Drawing the frame?** Start with the
> [**CAD brief**](../hardware/cad/CAD-BRIEF.md) — same content, ordered for
> someone about to open SolidWorks, with the workflow and the order of work.
> This document remains the binding list.
